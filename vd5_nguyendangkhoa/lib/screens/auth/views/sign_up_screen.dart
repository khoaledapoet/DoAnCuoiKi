    ...
    return BlocListener<SignUpBloc, SignUpState>(
      listener: (context, state) {
        if (state is SignUpSucces) {
          ...
          // *** ĐÃ XOÁ LỆNH Navigator.pop(context) Ở ĐÂY ***
          // AuthenticationBloc sẽ tự động lo việc chuyển sang màn hình chính.
                      ...
                      child: TextButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            // Không cần setState() ở đây nếu đã đọc bloc bằng context.read
